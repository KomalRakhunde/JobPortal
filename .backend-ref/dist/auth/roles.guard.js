...
let RolesGuard = class RolesGuard {
    ...
    canActivate(context) {
        ...
        if (!hasRole) {
            throw new common_1.ForbiddenException(`Forbidden resource. User role '${user.role}' is not authorized to access this endpoint. Required role: ${requiredRoles.join(', ')}`);
        }
        return true;
    }
};
